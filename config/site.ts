export const siteConfig = {
  ...
  cal: {
    ...
    classes: [
      ...
      {
        slug: "mma-little-kids",
        label: "MMA Little Kids",
        ageRange: "Ages 4–7",
        description: "Tue/Thu 4:15 PM",
        durationMin: 60,
        slots: [
          { day: "Tuesday", time: "4:15 PM" },
          { day: "Thursday", time: "4:15 PM" },
        ],
      },
      {
        slug: "mma-no-gi-kids",
  ...
  schedule: {
    adults: [
      ...
      { day: "Friday", times: ["6:00 AM", "10:30 AM", "12:00 PM", "6:30 PM"] },
      { day: "Saturday", times: ["9:00 AM", "10:15 AM"] },
      { day: "Sunday", times: ["10:00 AM"] },
    ],
    kids: [
      { day: "Monday", times: ["4:30 PM", "5:30 PM"] },
      { day: "Tuesday", times: ["4:15 PM", "4:30 PM", "5:30 PM"] },
      { day: "Wednesday", times: ["4:30 PM", "5:30 PM"] },
      { day: "Thursday", times: ["4:15 PM", "4:30 PM", "5:30 PM"] },
